...
import com.example.foodyapp.core.repository.FoodRecipesRepository
    ...
    private suspend fun getFoodJokeSafeCall(apiKey: String) {
        ...
        if (hasInternetConnection()) {
            try {
                ...
                val foodJoke = foodJokeResponse.value.let { it?.data }
                foodJoke?.let { offlineCacheFoodJoke(foodJoke) }
